...
$url = Mojo::MySQL5::URL->new('mysql:///test1');
...
$url = Mojo::MySQL5::URL->new('mysql://?PrintError=1');
is $url->dsn,      'dbi:mysql:dbname=',  'right data source';
is $url->username, '',                   'no username';
is $url->password, '',                   'no password';
$options = {
...
$url = Mojo::MySQL5::URL->new('mysql://127.0.0.1:8080/test2');
...
$url = Mojo::MySQL5::URL->new('mysql://mysql@/test3');
...
$url = Mojo::MySQL5::URL->new('mysql://0:0@/0?PrintError=1');
