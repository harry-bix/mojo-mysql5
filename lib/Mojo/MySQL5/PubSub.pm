...
L<Mojo::MySQL5::PubSub> is implementation of the publish/subscribe
pattern used by L<Mojo::MySQL5>.
...
L<Mojo::MySQL5::PubSub> inherits all events from L<Mojo::EventEmitter> and can
...
L<Mojo::MySQL5::PubSub> implements the following attributes.
...
L<Mojo::MySQL5> object this publish/subscribe container belongs to.

=head1 METHODS

L<Mojo::MySQL5::PubSub> inherits all methods from L<Mojo::EventEmitter> and
