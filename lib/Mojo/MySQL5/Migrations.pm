package Mojo::MySQL5::Migrations;
use Mojo::Base -base;
...
Mojo::MySQL5::Migrations - Migrations

=head1 SYNOPSIS

  use Mojo::MySQL5::Migrations;

  my $migrations = Mojo::MySQL5::Migrations->new(mysql => $mysql);
  $migrations->from_file('/home/sri/migrations.sql')->migrate;

=head1 DESCRIPTION

L<Mojo::MySQL5::Migrations> is used by L<Mojo::MySQL5> to allow database schemas to
...
L<Mojo::MySQL5::Migrations> implements the following attributes.
...
=head2 mysql
  ...
  $migrations = $migrations->mysql(Mojo::MySQL5->new);

L<Mojo::MySQL5> object these migrations belong to.

=head1 METHODS

L<Mojo::MySQL5::Migrations> inherits all methods from L<Mojo::Base> and implements
