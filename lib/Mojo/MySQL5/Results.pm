...
L<Mojo::MySQL5::Results> is a container for results returned by call to
$db->L<Mojo::MySQL5::Database/"query">.

=head1 METHODS

L<Mojo::MySQL5::Results> inherits all methods from L<Mojo::MySQL5::Results> and implements
the following ones.
